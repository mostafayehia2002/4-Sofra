...
module.exports = function(gulp, conf) {
  ...
  gulp.task('gh-pages', function(cb) {
    ...
    fs.writeFileSync(path.join(dest, 'dashboard.blade.php'), templates.index(data));
    data.title = ' - simple example';
    mkdirp(path.join(dest, 'examples', 'simple'));
    fs.writeFileSync(path.join(dest, 'examples', 'simple', 'dashboard.blade.php'), templates['examples/simple/index'](data));
    data.title = ' - lazyload example';
    mkdirp(path.join(dest, 'examples', 'lazy'));
    fs.writeFileSync(path.join(dest, 'examples', 'lazy', 'dashboard.blade.php'), templates['examples/lazy/index'](data));
