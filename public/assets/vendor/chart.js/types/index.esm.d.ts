...
export interface CartesianScaleOptions extends CoreScaleOptions {
  ...
  /**
   * Admin defined minimum value for the scale, overrides minimum value from data.
   */
  min: number;

  /**
   * Admin defined maximum value for the scale, overrides maximum value from data.
   */
  max: number;
...
export type LinearScaleOptions = CartesianScaleOptions & {
  ...
  */
  ...
  ticks: {
    ...
    /**
     * Admin defined fixed step size for the scale
     */
    stepSize: number;

    /**
     * Admin defined count of ticks
     */
    count: number;
  };
};
...
export type RadialLinearScaleOptions = CoreScaleOptions & {
  ...
  /**
   * Admin defined minimum number for the scale, overrides minimum value from data.
   */
  min: number;
  /**
   * Admin defined maximum number for the scale, overrides maximum value from data.
   */
  max: number;
